...
import image1 from '../../Assets/arab.jpg'
    ...
    return (
        <div className='leftaside bg-white d-flex flex-column'>
            <div className='d-flex flex-column profile shadow-lg  align-items-center'>
                <img src={image1} alt="" className='rounded-5 w-25 h-25 mt-5' />
                <div className='d-flex mt-4'>
                    <p className='fw-bold name'>Ram Mohan</p>
                ...
                <p className='fw-bold email'>rammohan2@gmail.com</p>
            </div>
            <div className={`mt-3 d-flex rounded-2 dash`} onClick={()=>{setItem('dash')}} >
                <img src={dashbord} alt="" className='dashIcon mt-2 ms-2' />
                <p className='fw-bold ms-2 mt-2'>Dashboard</p>
            </div>
            <div className='mt-3 d-flex rounded-2  dash' onClick={()=>{setItem('perk')}}>
                <img src={puzzle} alt="" className='dashIcon mt-2 ms-2' />
                <p className='fw-bold ms-2 mt-2'>Perks</p>
            </div>
            <div className='mt-3 d-flex rounded-2 dash' onClick={()=>{setItem('addon')}}>
                <img src={puzzle} alt="" className='dashIcon mt-2 ms-2' />
                <p className='fw-bold ms-2 mt-1'>Addons</p>
            </div>
            <div className='mt-3 d-flex rounded-2  dash' onClick={()=>{setItem('faq')}}>
                <img src={faq} alt="" className='dashIcon mt-2 ms-2' />
                <p className='fw-bold ms-2 mt-1'>FAQ</p>
            </div>
            <div className='mt-3 d-flex rounded-2  dash' onClick={()=>{setItem('support')}}>
                <img src={customer} alt="" className='dashIcon mt-2 ms-2' />
                <p className='fw-bold ms-2 mt-2'>Support</p>
            </div>
            <div className='position-absolute bottom-0 w-25 logout'>
